...
model = Sequential()
model.add(GRU(60, input_shape = (time_series_steps, len(time_series_feature_columns)), activation='sigmoid', return_sequences=True))
model.add(Dropout(0.1))
model.add(GRU(40, activation='sigmoid', return_sequences=True))
model.add(Dropout(0.1))
model.add(GRU(20, activation='sigmoid', return_sequences=True))
model.add(Dropout(0.1))
model.add(Dense(2))
