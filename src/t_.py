...
o = TCN(nb_filters=32, nb_stacks=2, kernel_size=4, activation='wavenet', name='tcn_1')(i)
o = TCN(nb_filters=64, nb_stacks=2, kernel_size=32, activation='wavenet', name='tcn_2')(o)
#o = TCN(nb_filters=128, nb_stacks=2, kernel_size=16, activation='wavenet', name='tcn_3')(o)
o = Flatten()(o)
