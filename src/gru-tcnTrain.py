...
o = GRU(128, return_sequences=True, activation='tanh', kernel_initializer=orthogonal, recurrent_initializer=orthogonal, recurrent_dropout=.2, name='gru_layer1')(i) 
o = Dropout(.2)(o)
...
model.compile(loss=huber_loss(0.001), optimizer=RAdam(learning_rate=1e-5))
print(model.summary())
history = model.fit(X, Y, epochs = 30000, batch_size = 2048, validation_data = (X_val, Y_val), verbose=2,
